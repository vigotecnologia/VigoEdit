...
namespace VigoEdit
{
    ...
    public class MaskedTextBox : TextBox
    {
        ...
        public static readonly DependencyProperty qualTipoProperty = DependencyProperty.Register("qualTipo", typeof(string), typeof(MaskedTextBox), new UIPropertyMetadata(OnMaskPropertyChanged));
        public string qualTipo
        {
            get { return (string)this.GetValue(qualTipoProperty); }
            set { this.SetValue(qualTipoProperty, value); }
        }
        ...
        protected override void OnPreviewKeyDown(KeyEventArgs e)
        {
            ...
            // Se for do tipo NÚMERO não permitir digitar caracteres

            if (qualTipo == "Numero")
            {
                if ((e.Key != Key.NumPad0) && (e.Key != Key.NumPad1) && (e.Key != Key.NumPad2) && (e.Key != Key.NumPad3) && (e.Key != Key.NumPad4) && (e.Key != Key.NumPad5) &&
                    (e.Key != Key.NumPad6) && (e.Key != Key.NumPad7) && (e.Key != Key.NumPad8) && (e.Key != Key.NumPad9) && (e.Key != Key.D0) && (e.Key != Key.D1) &&
                    (e.Key != Key.D2) && (e.Key != Key.D3) && (e.Key != Key.D4) && (e.Key != Key.D5) && (e.Key != Key.D6) && (e.Key != Key.D7) && (e.Key != Key.D8) &&
                    (e.Key != Key.D9) && (e.Key != Key.Enter) && (e.Key != Key.Tab) && (e.Key != Key.Back) && (e.Key != Key.Delete))
                    e.Handled = true;
            }

            // Valor pode digitar a vírgula

            else if (qualTipo == "Valor")
            {
                if ((e.Key != Key.NumPad0) && (e.Key != Key.NumPad1) && (e.Key != Key.NumPad2) && (e.Key != Key.NumPad3) && (e.Key != Key.NumPad4) && (e.Key != Key.NumPad5) &&
                    (e.Key != Key.NumPad6) && (e.Key != Key.NumPad7) && (e.Key != Key.NumPad8) && (e.Key != Key.NumPad9) && (e.Key != Key.D0) && (e.Key != Key.D1) &&
                    (e.Key != Key.D2) && (e.Key != Key.D3) && (e.Key != Key.D4) && (e.Key != Key.D5) && (e.Key != Key.D6) && (e.Key != Key.D7) && (e.Key != Key.D8) &&
                    (e.Key != Key.D9) && (e.Key != Key.Enter) && (e.Key != Key.Tab) && (e.Key != Key.Back) && (e.Key != Key.OemComma) && (e.Key != Key.Decimal) && (e.Key != Key.Delete))
                    e.Handled = true;
            }

            // Prossegue com o tratamento da máscara
    ...
    public partial class VigoEditControl : UserControl
    {
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            ...
            Rect rect = new Rect(0, 0, this.Width-1, 49);
            ...
            // Pinta todas as bordas

            drawingContext.PushGuidelineSet(guidelines);
            drawingContext.DrawRectangle(null, pen, rect);

            // Apaga as bordas que não estão definidas
        ...
        private void AjustaGeral()
        {
            ...
            // Verifica se é pra digitar somente números ou valor com ponto, vírgula, etc

            if (Tipo == "Numero")
                textbox.qualTipo = "Numero";
            else if (Tipo == "Valor")
                textbox.qualTipo = "Valor";
            else if (Tipo == "Senha")
                textbox.qualTipo = "Senha";
            else
                textbox.qualTipo = "";
        }
        ...
        {
            // Campo MAC colocar tudo em maiúsculo
        ...
        private bool ValidarConteudo()
        {
            ...
            try
            {
                ...
                TextoOriginal = TextoOriginal.Replace("–", "-").Replace("{", "(").Replace("}", ")"); // Remover o soft-hifen e as chaves
            }
            catch { TextoOriginal = ""; }
            ...
            try
            {
                ...
                textbox.Text = textbox.Text.Replace("–", "-").Replace("{", "(").Replace("}", ")"); // Remover o soft-hifen e as chaves
